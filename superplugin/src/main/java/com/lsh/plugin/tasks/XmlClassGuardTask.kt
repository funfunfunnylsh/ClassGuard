...
import com.lsh.plugin.entension.allDependencyAndroidProjects
import com.lsh.plugin.entension.findClassByLayoutXml
import com.lsh.plugin.entension.findClassByManifest
import com.lsh.plugin.entension.findFragmentInfoList
import com.lsh.plugin.entension.findLocationProject
import com.lsh.plugin.entension.findPackage
import com.lsh.plugin.entension.findXmlDirs
import com.lsh.plugin.entension.getDirPath
import com.lsh.plugin.entension.javaDirs
import com.lsh.plugin.entension.manifestFile
import com.lsh.plugin.entension.removeSuffix
import com.lsh.plugin.entension.replaceWords
import com.lsh.plugin.model.ClassInfo
import com.lsh.plugin.model.MappingParser
...
open class XmlClassGuardTask @Inject constructor(
    guardExtension: ConfigExtension,
